...
test('Checkout', async ({page}) => {
    ...
    //assertion que valida que estamos en el menu principal
    ...
    //assertion que valida que el carrito tiene un elemento
    ...
    //Assertion que valida que se guardaron los
    // datos correctamente y se muestra la siguiene pagina
    ...
    //Assertion que valida que se realizo la compra de manera exitosa
    ...
    //Assertion que valida que estamos en la pagina principal
    await expect(page).toHaveURL('https://www.saucedemo.com/inventory.html');
